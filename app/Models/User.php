...
class User extends Authenticatable
{
     ...
     */
    protected $fillable = [
        'first_name', 'last_name', 'gender','dob', 'phone', 'phone_verified_at', 'type', 'email', 'email_verified_at', 'password', 'status', 'remember_token', 'level', 'api_token', 'designation_id','service_id','latitude','longitude'
    ];
