...
class BulkImport implements ToModel,WithHeadingRow
{
    ...
    */
    ...
    {
        try {
            if(isset($row['SSN']) && isset($row['Date of Birth'])) {
                $user = new User;
                ...
                $patientReferralNotSsn = new PatientReferralNotSsn;
                $patientReferralNotSsn->referral_id = $this->referral_id;
                $patientReferralNotSsn->patient_id = isset($row['Admission ID']) ? $row['Admission ID'] : NULL;
                $patientReferralNotSsn->caregiver_code = isset($row['Caregiver Code']) ? $row['Caregiver Code'] : NULL;
                $patientReferralNotSsn->save();
