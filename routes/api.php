...
Route::group([
    ...
    // Unused api route end

    /* Routes used in api start*/
...
Route::group([
    ...
    Route::post('get-patient', 'App\Http\Controllers\PatientController@getPatient');
